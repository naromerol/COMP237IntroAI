...
neural_network3 = nl.net.newff([range_x1,range_x2], [6, num_outputs])

error_progress = neural_network3.train(input_nestor, output_nestor, epochs=200, 
                                      show=15, goal=0.00001)

# plt.figure()
# plt.plot(error_progress)

result3 = neural_network3.sim([[0.1,0.2]])
print('Predicted result for (0.1,0.2) neural network NN3. Result 3 =', result3)