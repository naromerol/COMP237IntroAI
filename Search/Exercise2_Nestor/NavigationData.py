...
connections["Library"] = {"Car Park", "Student Center"}
connections["Car Park"] = {"Maths Building", "Store"}
connections["Maths Building"] = {"Canteen"}
connections["Student Center"] = {"Store" , "Theater"}
connections["Store"] = {"Car Park", "Canteen"}
connections["Canteen"] = {"AI Lab"}
connections["Theater"] = {"Sports Center"}
connections["Sports Center"] = {"Store"}
